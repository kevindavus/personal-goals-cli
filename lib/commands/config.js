...
const conf = new Configstore("personal-goals-cli", defaultConf);
const chalk = require("chalk");

const confFocus = conf.get("focus");
const confAliases = conf.get("alias");
const confTitles = conf.get("title");
const confTypes = conf.get("types");
const confDir = conf.get("dir");
const confReadme = conf.get("readme");
